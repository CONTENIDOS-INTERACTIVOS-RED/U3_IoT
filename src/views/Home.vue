        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 3 del curso "Internet de las Cosas" se centra en el desarrollo de aplicaciones y análisis de datos en IoT, abordando desde plataformas de hardware como Arduino y Raspberry Pi, hasta herramientas de visualización como Grafana y Power BI. Se estudian métodos de recolección, almacenamiento y procesamiento de datos en tiempo real y la integración de hardware y software. Además, se destaca la importancia del análisis inteligente y visualización para la toma de decisiones. La unidad incluye ejercicios prácticos que consolidan los conceptos mediante implementaciones reales.
